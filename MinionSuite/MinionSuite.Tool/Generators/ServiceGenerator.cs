    ...
    public class ServiceGenerator : IGenerator
    {
        ...
        private string GetClassContent(ArgReader argReader, ModelMetadata metadata)
        {
            ...
            builder
                ...
                .AppendNestedLine(2, "{")
                .AppendNestedLine(3, $"return _context.{metadata.PluralName}.AsNoTracking().ToListAsync();")
                .AppendNestedLine(2, "}")
                .AppendLine()
            ...
            if (!string.IsNullOrEmpty(searchQuery))
            {
                builder
                    ...
                    .AppendNestedLine(2, "{")
                    .AppendNestedLine(3, $"return _context.{metadata.PluralName}.AsNoTracking().Where(w => {searchQuery}).ToListAsync();")
                    .AppendNestedLine(2, "}")
                    .AppendLine()
