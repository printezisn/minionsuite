    ...
    public class PageModelGenerator : IGenerator
    {
        ...
        private string GetClassContent(ArgReader argReader)
        {
            ...
            return builder
                ...
                .AppendNestedLine(2, "public string SortField { get; private set; }")
                .AppendNestedLine(2, "public bool IsAscending { get; private set; }")
                .AppendLine()
                ...
                .AppendNestedLine(2, "}")
                .AppendLine()
                .AppendNestedLine(2, "public static async Task<PageModel<T>> CreateAsync(IQueryable<T> query, int page, int pageSize, string sortField, bool asc)")
                .AppendNestedLine(2, "{")
                .AppendNestedLine(3, "var pageModel = new PageModel<T>();")
                .AppendLine()
                .AppendNestedLine(3, "pageModel.SortField = sortField;")
                .AppendNestedLine(3, "pageModel.IsAscending = asc;")
        ...
        private string GetInterfaceContent(ArgReader argReader)
        {
            ...
            return builder
                ...
                .AppendNestedLine(2, "string SortField { get; }")
                .AppendNestedLine(2, "bool IsAscending { get; }")
                .AppendNestedLine(1, "}")
                .AppendNestedLine(0, "}")
                .ToString();
        }
