...
namespace MinionSuite.Tool
{
    class Program
    {
        ...
        private static void ShowHelpMessage()
        {
            ...
            builder.AppendLine("  mvccontroller:test:\tgenerates tests for the MVC controller of a model class.");
            builder.AppendLine("  apicontroller:\tgenerates an API controller with CRUD operations on a model class.");
